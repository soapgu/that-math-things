...
| 8. 文档与发布 | 🔄 进行中 | 统一版本并完成正式发布 | README、发布清单、v2.6.0 Release |
...
- 包版本和页面注入版本正在统一为 `2.6.0`。
- 新增 [v2.6.0 发布检查清单](./docs/v2.6.0-release-checklist.md)与 [v2.6.0 Release Notes](./docs/v2.6.0-release-notes.md)，保留 v2.5.0 历史发布记录。
- 发布候选须依次通过 Vitest、生产构建、完整 Playwright E2E、GitHub Actions 和差异检查。
- CI 通过后创建 `v2.6.0` 标签与 Release，并将同一发布候选部署到 GitHub Pages。
- 线上冒烟完成后记录发布证据，并将步骤 8 标记为完成。
