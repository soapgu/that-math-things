...
v2.0–v2.5.0 已完成并发布。v2.6“九九乘法闯关”的产品规格、UE 页面流程设计和低保真交互原型已完成，下一步为 UI 视觉设计。阶段性实施记录见 [STEP.md](./STEP.md)，详细规格见 [docs/v2.6-九九乘法闯关实施计划.md](./docs/v2.6-九九乘法闯关实施计划.md)，UE 设计见 [docs/v2.6-九九乘法闯关UE页面流程设计.md](./docs/v2.6-九九乘法闯关UE页面流程设计.md)，已验收原型见 [docs/v2.6-九九乘法闯关低保真交互原型.md](./docs/v2.6-九九乘法闯关低保真交互原型.md)。
