...
v2.0–v2.5.0 已完成并发布。v2.6“九九乘法闯关”的累计开图、81 题低保真和高保真视觉均已通过体验确认，下一步为技术原型与基础模型。阶段性实施记录见 [STEP.md](./STEP.md)，详细规格见 [docs/v2.6-九九乘法闯关实施计划.md](./docs/v2.6-九九乘法闯关实施计划.md)，UE 设计见 [docs/v2.6-九九乘法闯关UE页面流程设计.md](./docs/v2.6-九九乘法闯关UE页面流程设计.md)，已验收原型与视觉规范见 [docs/v2.6-九九乘法闯关UI视觉设计.md](./docs/v2.6-九九乘法闯关UI视觉设计.md)。
