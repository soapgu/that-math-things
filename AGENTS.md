...
v2.0–v2.5.0 已完成并发布。v2.6“九九乘法闯关”正在重新验证累计开图与 81 题全表模式：步骤 3 待体验确认，步骤 4 待重新验收，步骤 5 暂缓。阶段性实施记录见 [STEP.md](./STEP.md)，详细规格见 [docs/v2.6-九九乘法闯关实施计划.md](./docs/v2.6-九九乘法闯关实施计划.md)，UE 设计见 [docs/v2.6-九九乘法闯关UE页面流程设计.md](./docs/v2.6-九九乘法闯关UE页面流程设计.md)，原型与视觉规范见 [docs/v2.6-九九乘法闯关UI视觉设计.md](./docs/v2.6-九九乘法闯关UI视觉设计.md)。
