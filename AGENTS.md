...
v2.0–v2.5.0 已完成并发布。v2.6“九九乘法闯关”已完成步骤 1–7，下一步进行步骤 8“文档与发布”。阶段性实施记录见 [STEP.md](./STEP.md)，详细规格见 [docs/v2.6-九九乘法闯关实施计划.md](./docs/v2.6-九九乘法闯关实施计划.md)，验收证据见 [docs/v2.6-九九乘法闯关测试与体验验收.md](./docs/v2.6-九九乘法闯关测试与体验验收.md)。
