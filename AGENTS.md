...
v2.0–v2.5.0 已完成并发布。v2.6“九九乘法闯关”的产品、交互、视觉和技术原型与基础模型均已完成，下一步为纵向功能实现。阶段性实施记录见 [STEP.md](./STEP.md)，详细规格见 [docs/v2.6-九九乘法闯关实施计划.md](./docs/v2.6-九九乘法闯关实施计划.md)，领域接口与验证证据见 [docs/v2.6-九九乘法闯关技术原型与基础模型.md](./docs/v2.6-九九乘法闯关技术原型与基础模型.md)。
